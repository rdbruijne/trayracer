...
constexpr float RcpFourPi        = 0.0795774715459477f; // 1 / (4 * Pi) = 0.25 / Pi
constexpr float RcpPiOverTwo     = 0.6366197723675813f; // 1 / (Pi/2)
constexpr float RcpPiOverFour    = 1.2732395447351627f; // 1 / (Pi/4)
...
constexpr float FourOverPiSquare = 0.4052847345693511f; // 4 / (Pi^2)
...
constexpr float Phi              = 1.6180339887498948f; // Golden Ratio: (1 + sqrt(5)) / 2
