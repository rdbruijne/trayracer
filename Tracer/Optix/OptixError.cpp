...
namespace Tracer
{
	std::string Tracer::ToString(OptixResult optixResult)
	{
		switch(optixResult)
		{
		case OPTIX_SUCCESS:
		...
		case OPTIX_ERROR_ILLEGAL_DURING_TASK_EXECUTE:
			return "OPTIX_ERROR_ILLEGAL_DURING_TASK_EXECUTE";
		...
		case OPTIX_ERROR_PAYLOAD_TYPE_ID_INVALID:
			return "OPTIX_ERROR_PAYLOAD_TYPE_ID_INVALID";
